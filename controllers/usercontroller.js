...
//    LICENSE_NUBER, PHONE, CREATED_AT FROM USER
//   `;
...
//      LICENSE_NUMBER, PHONE FROM USER WHERE ROLE = 'doctor'
//     `;
...
//         }
//         return res.status(200).json({
//             message: 'Dcotor retrieved successfully',
//             data: rows,
//         });
//     });
// };
...
//     const query =`
//      SELECT ID, FULL_NAME, EMAIL, ROLE, SPECIALIZATION, 
//      LICENSE_NUMBER, PHONE, CREATED_AT FROM USER WHERE ID = ?
//     `;
...
//   // Basic validation
//   if (!fullNam || !email || !role || !password) {
